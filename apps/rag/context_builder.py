...
def course_to_text(course_meta: dict) -> str:
    ...
    lines = [
        ...
        f"  Instructor: {course_meta.get('instructor', 'N/A')}",
        f"  Level: {course_meta.get('level', 'N/A')} | Duration: {duration} | Hours: {hours or 'N/A'}h",
        f"  Rating: {course_meta.get('rating', 'N/A')}/5 ({course_meta.get('reviews_count', 0)} reviews)",
